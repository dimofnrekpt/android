...
fun PublicKeyCredentialAuthenticatorAssertionResponse.toAndroidFido2PublicKeyCredential() =
    Fido2PublicKeyCredential(
        ...
        type = this.ty,
        authenticatorAttachment = authenticatorAttachment.orEmpty(),
        ...
        clientExtensionResults = Fido2PublicKeyCredential.ClientExtensionResults(
            credentialProperties = Fido2PublicKeyCredential.ClientExtensionResults.CredentialProperties(
                residentKey = clientExtensionResults.credProps?.rk ?: true,
            )
        )
    )
